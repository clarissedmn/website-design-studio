...
export const TEXT_SET = [
  ...
  "Through this cultural differences, I met a lot of people during this week especially Taiwanese and German people in my workshop group about « Urban Resilience & Disaster Management ». In this way, we try to made up an international mix of members in order to work together constructively with differences in work style and communication methods. It was interesting to see the difference between how you imagine your own culture and how your culture is perceiving by others.",
  "During the workhop, our group talked together about the fact that Taipei is a scaling city and must face demographic changes. Due to a aged society and low birth rate, the city become a shrinking city. New socio-economic challenges appear : how to adapt housings, healthcare, mobility or environment?  Our goal was to understand in detail the impacts of these changes and to create possible solutions for the future city of Taipei.",
  ...
  "Biking is a convenient and environmentally friendly way to get around Taipei. UBike, the Taipei City public bicycle system, is an excellent way to explore the city. The UBike's goal is to encourage people to use less polluting and low energy consumption transportation, in order to improved urban traffic congestion, reduce environmental pollution and energy consumption purposes. It has become a real lifestyle for Taiwanese people."
];
